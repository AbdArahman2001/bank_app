...
import 'package:bank_app_flutter/video_package/widget/other/floating_action_button_widget.dart';
...
class _FilePlayerWidgetState extends State<FilePlayerWidget> {
  ...
  Future pickVideoFile() async {
    final result = null; //await FilePicker.platform.pickFiles(type: FileType.video);
