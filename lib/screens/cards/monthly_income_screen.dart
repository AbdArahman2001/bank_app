                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: Text(
                                  "Remaining from monthly income source after tabulation"
                                      .tr(),
                                  style: TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w900,
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Text(
                                    NumberFormat('###,##0.00')
                                        .format(provider.getRemainingAmount()),
                                    style: TextStyle(
                                      fontSize: 13,
                                      fontWeight: FontWeight.w400,
                                      fontFamily: "Segoe UI",
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Row(children: [
                      Visibility(
                        visible: provider.isDeleteEnable,
                        child: GestureDetector(
                            child: Container(
                              decoration: BoxDecoration(
                                // border: Border.all(),
