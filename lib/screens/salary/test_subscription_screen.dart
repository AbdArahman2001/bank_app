...
const String _kSilverSubscriptionId = 'bank-1-month';
const String _kGoldSubscriptionId = 'bank-1-year';
...
class TestSubscriptionScreen extends StatefulWidget {
  static final String routeName = "/subscriptionScreen";
  @override
...
class _TestSubscriptionScreenState extends State<TestSubscriptionScreen> {
  ...
  void initState() {
    ...
    _subscription = purchaseUpdated.listen((List<PurchaseDetails> purchaseDetailsList) {
      ...
      print("--------------------------\nDone listening to purchase updates");
  ...
  Future<void> initStoreInfo() async {
    ...
    print("-----------------------------\n"
        "start init store info isAvailable: $_isAvailable");
  ...
  Future<void> _listenToPurchaseUpdated(
    ...
    print("start listening to purchase details list");
    for (final PurchaseDetails purchaseDetails in purchaseDetailsList) {
      if (purchaseDetails.status == PurchaseStatus.pending) {
        print(
            "----------------------------------------------\n"
            "purchase status: pending - purchase details: \n"
        ...
        if (purchaseDetails.status == PurchaseStatus.error) {
          ...
          if (valid) {
            ...
            print("--------------valid verification purchase\n purchase details:\n"
        ...
        if (Platform.isAndroid) {
          ...
          BillingResultWrapper billingResultWrapper =  await androidAddition.consumePurchase(purchaseDetails);
            print("--------------in android platform\n billing result:\n"
                "responseCode: ${billingResultWrapper.responseCode} "
